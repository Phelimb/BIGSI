...
REDIS_PORT = 6379
REDIS_CLUSTER_STORAGE_REDIS = {"conn": [(REDIS_HOST, REDIS_CLUSTER_PORT, 0)], "credis": False}
REDIS_CLUSTER_STORAGE_CREDIS = {"conn": [(REDIS_HOST, REDIS_CLUSTER_PORT, 0)], "credis": True}
