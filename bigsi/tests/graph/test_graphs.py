...
def test_query_kmers():
    ...
    assert bigsi._search([k1, k2], threshold=0.5, score=score).get("1234").get("percent_kmers_found") >= 100
    assert bigsi._search([k1, k2], threshold=0.5, score=score).get("1235").get("percent_kmers_found") >= 50

    assert bigsi._search([k1, k2], score=score).get("1234").get("percent_kmers_found") >= 100

    assert bigsi._search([k1, k3], threshold=0.5, score=score).get("1234").get("percent_kmers_found") >= 50
    assert bigsi._search([k1, k3], threshold=0.5, score=score).get("1235").get("percent_kmers_found") >= 100
    assert bigsi._search([k1, k3], threshold=0.5, score=score).get("1236").get("percent_kmers_found") >= 50

    assert bigsi._search([k5], score=score).get("1234").get("percent_kmers_found") >= 100
    assert bigsi._search([k5], score=score).get("1235").get("percent_kmers_found") >= 100
    assert bigsi._search([k5], score=score).get("1236").get("percent_kmers_found") >= 100
