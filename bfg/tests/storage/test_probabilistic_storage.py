...
from bfg.tests.base import ST_SAMPLE_COLOUR
from bfg.tests.base import REDIS_CLUSTER_STORAGE_CREDIS
from bfg.tests.base import REDIS_CLUSTER_STORAGE_REDIS
import hypothesis
